                ...
                <div class="carousel-inner">
                    @foreach (json_decode($settings->slider_images) as $key => $slider)
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                            <img src="{{ asset('user_images/settings/' . ($slider ?? '')) }}" style="max-height: 500px"
                ...
                <div class="col-lg-12">
                    <div class="row" style="border-radius: 20px">
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <input type="text" class="form-control search-slt" name="q" placeholder="كلمة البحث"
                                style="direction: rtl">
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <select class="form-control search-slt" style="direction: rtl" name="category"
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <select class="form-control search-slt" style="direction: rtl" name="city"
                                id="exampleFormControlSelect1">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <button type="submit" class="btn wrn-btn"
                                style="background-color: #7d0505;color: white">بحث</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-3 " style="margin-top:20px;margin-bottom:20px">
                        ...
                        <div class="card crad-no1 Cards">
                            ...
                            <div class="card-body">
                                ...
                                </a>                                <p class="card-text TwoProp" style="text-align: left">
            ...
            <div class="row Row-Cards ml-1">
                ...
                @foreach ($buyers_advertisements as $advertisement)
                    <div class="col-md-3 " style="margin-top:20px;margin-bottom:20px">
                        ...
                        <div class="card crad-no1 Cards">
                            <a
                                href="{{ route('site.buyer.advertismenets.show', ['advertisement' => $advertisement->id, 'title' => $advertisement->title]) }}">
                                <img class="card-img-top"
                                    src="{{ asset('user_images/images/' . (json_decode($advertisement->images)[0] ?? '')) }}"
                                    alt="Card image cap" style="max-height: 250px;min-height: 250px">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text Card-Footer" style="    padding: 1px">
                                    <small class="text-muted">
                                        <span class="text-muted dataEnd">
                                            {{ is_null($advertisement) ? '' : Carbon\Carbon::parse($advertisement->end_publish_date)->diffForHumans() }}
                                        </span>
                                        <i class="fa fa-clock-o" class="text-muted" aria-hidden="true"></i>
                                    </small>
                                </p>
