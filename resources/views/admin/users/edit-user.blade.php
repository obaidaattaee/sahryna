        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase">المستخدمين /   تعديل بيانات المستخدم </span>
                </div>
                        ...
                        <div class="col-md-10">
                            <div class="md-checkbox-list">
                                @foreach ($roles as $index => $role)
                                    ...
                                    <input type="checkbox" id="checkbox{{ $index }}" class="md-check" name="roles[]" value="{{$role->id}}" {{$user->hasRole($role->name) ? "checked" : ""}}>
