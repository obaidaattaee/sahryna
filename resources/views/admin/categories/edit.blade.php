        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase">التصنيفات / تعديل  تصنيف<span>
                </div>
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <div class="md-checkbox-list">
                                    ...
                                    <input type="checkbox" id="checkbox1" class="md-check" name="active"  {{ $category->active  ? "checked" : ""}}>
                                        <label for="checkbox1">
                                        <span class="inc"></span>
